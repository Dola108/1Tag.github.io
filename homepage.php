...
<body style="background-color: white; overflow-x: hidden;">
	...
	<nav>
	  <ul class="ls">
	    ...
	    <li class="ls"><a href="rule.php" target="_blank">Rulebook</a></li>
	  </ul>
	</nav>
	...
	<article>
		<h2>What is 1Tag?</h2>
		<div class="div boxed">
			<p style="font-size: 20px; color: #ACE3C4; " style="font-family: sans-serif;" >1Tag is an only one hashtag discussion page where anyone with an account can post anything, make comments, upvote and downvote posts. They can also post images with their posts. There is a list given of the most common topics that u can use as a tag or browse piosts related to that tag. Users do not need to register if they only wish to browse posts by tag. Click any of the hashtags and get the most recent and most popular posts of that topic.</p>
		</div>
	</article>
	...
	<article>
		<h2>Tags:</h2>
		<div class="div boxed" style="height: 5em;">
			<ul class="tg">
