...
<?php 
    ...
    if (empty($_SESSION['uname'])) {
    	echo "<script>
					alert('Log in to view full post!');window.close();
			</script>";
      	exit();
    }
	...
	<div class=\"commentbox\" style='margin-left:-6.5%;'>
		<form class='cform' id=".$id." action=\"#\" enctype=\"multipart/form-data\" method=\"post\">
			...
			<div class=\"form-group\">
				...
				<input type=\"button\" id=\"cross\" class=\"button4\" style=\"display:none;position:inline-flex; padding:6px 14px;margin-left:-58px;\" value=\"cancel\" />
				<input type=\"submit\" name=\"submit\" id=\"submit\" class=\"button4\" style=\"position:inline-flex;padding:6px 14px;\" value=\"post\" />
			<span id=\"pp\" style=\"position:absolute;font-size: 16px; color: #eaeaea;margin-left:-160px;\"></span>
			</div>
		</form>
	</div>
