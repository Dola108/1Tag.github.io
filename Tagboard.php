...
<body style="background-image: url('jjj.jpg'); object-fit: cover;">
	...
	<?php endif ?>
	<?php if (empty($uname)): ?>
	<div class="results" id="livesearch" style="display:none;position:fixed;z-index:1;max-height: 300px;width: 207px;font-family: sans-serif;overflow: auto;margin-left:500px;margin-top: 2.5%;color: #eaeaea;">no suggestion</div>
	<?php endif ?>
	...
	<div style="position: absolute; float: left; margin-left: 5px; margin-top: 50px;">
		...
		?>
	<p style="font-size: 14px;font-family: sans-serif;color: #eaeaea">@1Tag.com<br><br><a href="rule.php" target="_blank" style="color: dodgerblue;font-size: 12px;">Terms & conditions</a><br><a href="rule.php" target="_blank" style="color: dodgerblue;font-size: 12px;">RuleBook</a></p>
	</div>
